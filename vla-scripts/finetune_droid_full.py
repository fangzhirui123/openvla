...
class FinetuneConfig:
    ...
    lora_rank: int = 128 #32                                             # Rank of LoRA weight matrix
...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    exp_root_dir = '/mnt/petrelfs/share_data/fangzhirui/tensorboard/embodied_test/vla_{}_{}_{}'.format(cfg.warp_dataset_name, cfg.tag, current_time)
...
#
    ...
    with tqdm.tqdm(total=cfg.max_steps, leave=False) as progress:
        ...
        while True:
            ...
            for step_idx, batch in enumerate(dataloader):
                print("step_idx",step_idx,"step_i",step_i)
    ...
    #    device='cuda:0', dtype=torch.bfloat16), 'input_ids': tensor([[]]), 'attention_mask': tensor([[True,  True,  True,  True,  True,  True,  True,  True,  True,  True,
    #       True,  True,  True,  True,  True,  True,  True,  True,  True,  True,
    #       True,  True,  True,  True,  True,  True,  True,  True,  True,  True,
    #       True, False, False]]), 'labels': tensor([[]]), 'dataset_names': ['calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin', 'calvin']}
