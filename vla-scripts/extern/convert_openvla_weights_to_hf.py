...
class HFConvertConfig:
    ...
    openvla_model_path_or_id: Union[str, Path] = (                      # Path to Pretrained VLA (on disk or HF Hub)
        "/mnt/petrelfs/share_data/fangzhirui/tensorboard/embodied1/vla_calvin_t1_o1_lab_907_1_920_euler5_calvin_20241107142255/openvla-7b+calvin_task_ABC_D+b16+lr-0.0002+lora-r64+dropout-0.0_5000"
    )
    output_hf_model_local_path: Path = Path(                            # Path to Local Path to save HF model
        "/mnt/petrelfs/share_data/fangzhirui/tensorboard/embodied1/5000/openvla-7b"
    )
