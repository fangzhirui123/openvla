...
# = [64 GPU] DINO-SigLIP 224px + OXE Magic Soup++ =
@dataclass
class Exp_INTERNVL2_224px_OXE_Magic_Soup_Plus(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-internvl2-224px+mx-oxe-magic-soup-plus"
    base_vlm: Union[str, Path] = "prism-internvl2-224px+4b"
    # base_vlm: Union[str, Path] = "prism-dinosiglip-224px+8b"
