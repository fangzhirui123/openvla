...
from prismatic.vla.action_tokenizer import ActionTokenizer, InternVLActionTokenizer
from prismatic.vla.datasets.datasets import DummyDataset1, RLDSBatchTransform_INTERNVL, RLDSBatchTransform_lab
...
def get_vla_dataset_and_collator(
    ...
    if backbone == 'internvl':
        action_tokenizer = InternVLActionTokenizer(tokenizer)
        batch_transform =RLDSBatchTransform_INTERNVL(
    ...
    elif batch_size is not None and dataset_name=="calvin":
