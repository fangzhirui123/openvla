...
LLAMA2_MODELS = {
    # === Pure Meta LLaMa-2 (non-instruct/chat-tuned) Models ===
    "llama2-7b-pure": {
        "llm_family": "llama2", "llm_cls": LlamaForCausalLM, "hf_hub_path": "/mnt/petrelfs/share_data/zhangqinglong/Husky/work_dirs/Llama-2-7b-hf"
    },
    ...
    "llama3-8b-pure": {
        "llm_family": "llama3", "llm_cls": LlamaForCausalLM, "hf_hub_path": "/mnt/petrelfs/share_data/wangwenhai/llm/Meta-Llama-3-8B"
    },
    ...
    # === Vicuna v1.5 Chat Models ===
    "vicuna-v15-7b": {
        "llm_family": "llama2", "llm_cls": LlamaForCausalLM, "hf_hub_path": "/mnt/petrelfs/share_data/wangwenhai/llm/vicuna-7b-v1.5"
    },
