...
class PrismaticVLM(VLM):
    def __init__(
        ...
        **kwargs,
        ...
        if 'DIFFHEAD' in os.environ:
            self.diffuse_action_head = DenoisingMLP(in_channels=4096, out_channels=7, num_blocks=3, width=4096, num_conds=4096)
    ...
    def gradient_checkpointing_enable(self, gradient_checkpointing_kwargs):
        self.vision_backbone.dino_featurizer.set_grad_checkpointing(True)
        self.vision_backbone.siglip_featurizer.set_grad_checkpointing(True)
