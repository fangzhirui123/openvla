...
class CalvinDataset_Policy(Dataset):
    ...
    def _initialize(self):
        ...
        self.anns = np.load(io.BytesIO(self.client.get(f"{self.dataset_dir}/lang_annotations/auto_lang_ann.npy")), allow_pickle=True)[()]#/mnt/petrelfs/share_data/zhangtianyi1/
        #self.anns = np.load(io.BytesIO(self.client.get(f"/mnt/petrelfs/share_data/zhangtianyi1/task_ABC_D/training/lang_annotations/auto_lang_ann.npy")), allow_pickle=True)[()]
...
if __name__ == "__main__":
    ...
    data_dir = "/mnt/petrelfs/share_data/zhangtianyi1/"
    subfolder = 'task_ABC_D'
    # seq_len = 2
    # num_pred_action = 31
